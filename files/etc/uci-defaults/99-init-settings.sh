...
# Header log
log_status "INFO" "========================================="
log_status "INFO" "Anang-WRT Setup Script Started"
...
if (echo "anang"; sleep 2; echo "anang") | passwd > /dev/null 2>&1; then
...
check_status "uci set system.@system[0].hostname='Anang-WRT'" "Hostname set to Anang-WRT"
...
if grep -q "Raspberry Pi 4\|Raspberry Pi 3" /proc/cpuinfo; then
    ...
    check_status "uci set wireless.@wifi-iface[0].ssid='Anang-WRT_5G'" "5GHz WiFi SSID set to Anang-WRT_5G"
    ...
    check_status "uci set wireless.@wifi-iface[0].ssid='Anang-WRT'" "WiFi SSID set to Anang-WRT"
...
log_status "INFO" "========================================="
log_status "INFO" "Anang-WRT Setup Script Finished"
